...
CREATE INDEX IF NOT EXISTS idx_questions_academy_id ON questions(academy_id);
...
CREATE INDEX IF NOT EXISTS idx_homeworks_academy_id ON homeworks(academy_id);
...
CREATE INDEX IF NOT EXISTS idx_homeworks_due_at ON homeworks(due_at);
...
CREATE INDEX IF NOT EXISTS idx_homework_assignments_homework_id ON homework_assignments(homework_id);
CREATE INDEX IF NOT EXISTS idx_homework_assignments_student_id ON homework_assignments(student_id);
...
CREATE INDEX IF NOT EXISTS idx_submissions_exam_id ON submissions(exam_id) WHERE exam_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_submissions_homework_id ON submissions(homework_id) WHERE homework_id IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_submission_answers_is_correct ON submission_answers(is_correct);
...
CREATE INDEX IF NOT EXISTS idx_wrong_notes_student_id ON wrong_notes(student_id);
CREATE INDEX IF NOT EXISTS idx_wrong_notes_question_id ON wrong_notes(question_id);
CREATE INDEX IF NOT EXISTS idx_wrong_notes_mastered ON wrong_notes(mastered);
CREATE INDEX IF NOT EXISTS idx_wrong_notes_next_review_at ON wrong_notes(next_review_at) WHERE mastered = false;
CREATE INDEX IF NOT EXISTS idx_wrong_notes_last_wrong_at ON wrong_notes(last_wrong_at);
CREATE INDEX IF NOT EXISTS idx_wrong_notes_times_wrong ON wrong_notes(times_wrong DESC);
...
DROP TRIGGER IF EXISTS trg_homeworks_updated_at ON homeworks;
...
DROP TRIGGER IF EXISTS trg_exam_questions_total_points ON exam_questions;
...
DROP TRIGGER IF EXISTS trg_homework_questions_total_points ON homework_questions;
...
DROP TRIGGER IF EXISTS trg_submission_answers_statistics ON submission_answers;
